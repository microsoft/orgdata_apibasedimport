...
``` git clone https://github.com/microsoft/modis_ingressupload.git``` 
...
1. ``` .\OrganizationalDataUpload.ps1 -ClientId **** -pathToFile  "C:\repos\temp\info.zip" -TenantId ***** -ingressDataType HR -ClientSecret **** ```

2. ``` .\OrganizationalDataUpload.ps1 -ClientId **** -pathToFile  "C:\repos\temp\info.zip" -TenantId ***** -ingressDataType Survey -certificateName CN=ypochampally-certificate```
